    ...
    <div className="rounded-2xl border border-slate-200 bg-[oklch(99%_0.004_90)] p-5 shadow-sm">
      ...
      <div className="mt-4 space-y-2">
        {items.length ? (
          ...
          <p className="rounded-xl bg-slate-50 px-3 py-3 text-sm font-semibold leading-6 text-slate-500">
            Pronto encontrarás contenido destacado para acompañar tu ministerio.
          </p>
        )}
      </div>
    </div>
