    ...
    <section className="space-y-5">
      ...
      <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-3">
        {state.resources.length ? (
          ...
          <div className="rounded-2xl border border-dashed border-slate-300 bg-[oklch(99%_0.004_90)] p-6 text-center shadow-sm md:col-span-2 xl:col-span-3">
            <p className="text-sm font-black text-[#0B2545]">Muy pronto llegarán nuevos recursos</p>
            <p className="mt-2 text-sm font-semibold leading-6 text-slate-500">Estamos preparando materiales para acompañar tus ensayos, clases y tiempos de adoración.</p>
          </div>
        )}
      </div>
    </section>
