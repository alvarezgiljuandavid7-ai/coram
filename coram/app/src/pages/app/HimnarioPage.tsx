  ...
  return (
    <section className="space-y-5">
      <LibraryHeader
        ...
        subtitle="Himnos listos para acompañar tus tiempos de adoración, ensayo y enseñanza."
        value={query}
        onChange={setQuery}
        ...
        <div className="rounded-2xl border border-slate-200 bg-[oklch(99%_0.004_90)]">
          {hymnsLoading ? (
            ...
            <div className="divide-y divide-slate-100">
              {filtered.length ? filtered.map((hymn) => (
                <button
                  key={hymn.id}
                  type="button"
                ...
                <div className="p-6 text-sm font-semibold leading-6 text-slate-500">
                  No encontramos himnos con esa búsqueda. Intenta con otro número, título o frase de la letra.
                </div>
              )}
            </div>
          )}
