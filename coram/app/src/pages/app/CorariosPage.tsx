    ...
    <section className="space-y-5">
      ...
      <div className="grid gap-4 xl:grid-cols-[1fr_420px]">
        <div className="grid gap-3 md:grid-cols-2 2xl:grid-cols-3">
          {filtered.length ? filtered.map((corario) => (
            <button
              key={corario.id}
              type="button"
            ...
            <div className="rounded-2xl border border-dashed border-slate-300 bg-[oklch(99%_0.004_90)] p-6 text-center shadow-sm md:col-span-2 2xl:col-span-3">
              <p className="text-sm font-black text-[#0B2545]">No encontramos corarios</p>
              <p className="mt-2 text-sm font-semibold leading-6 text-slate-500">Prueba con otra palabra, tono o categoría para encontrar el canto que necesitas.</p>
            </div>
          )}
        </div>
