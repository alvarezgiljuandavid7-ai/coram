  ...
  return (
    <section className="space-y-5">
      <div className="rounded-3xl border border-slate-200 bg-[oklch(99%_0.004_90)] p-6 shadow-sm">
        ...
        <h1 className="mt-3 text-3xl font-black tracking-tight text-[#0B2545]">Entrenamiento vocal y piano</h1>
        ...
        {tools.map((tool) => {
          ...
          return (
            <Link
              key={tool.to}
              to={tool.to}
              className="rounded-2xl border border-slate-200 bg-[oklch(99%_0.004_90)] p-5 shadow-sm transition hover:-translate-y-0.5 hover:border-[#D4AF37]/60 hover:shadow-md"
            >
